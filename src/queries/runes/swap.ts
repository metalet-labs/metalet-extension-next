...
export const previewSwap = async ({
  ...
  return await swapApi<SwapPreviewResult>('/preview/swap').post({
    token1,
    token2,
    address,
    swapType,
...
const build1xSwap = async (params: SwapBuildParams): Promise<SwapBuildResult> => {
  const res = await swapApi<Omit<SwapBuildResult, 'feeRate'>>('/build/1x').post(params)
  return {
    ...res,
...
const buildX2Swap = async (params: SwapBuildParams): Promise<SwapBuildResult> => {
  const res = await swapApi<Omit<SwapBuildResult, 'feeRate'>>('/build/x2').post(params)
  return {
    ...res,
    feeRate: params.feeRate,
  }
...
const build2xSwap = async (params: SwapBuildParams): Promise<SwapBuildResult> => {
  const res = await swapApi<Omit<SwapBuildResult, 'feeRate'>>('/build/2x').post(params)
  return {
    ...res,
    feeRate: params.feeRate,
  }
...
const buildX1Swap = async (params: SwapBuildParams): Promise<SwapBuildResult> => {
  const res = await swapApi<Omit<SwapBuildResult, 'feeRate'>>('/build/x1').post(params)
  return {
    ...res,
    feeRate: params.feeRate,
  }
...
const getOngoingTask = async ({
  ...
  return await swapApi<Task>('/ongoing-task').get({
    address,
    net: network,
    build_id: buildId,
  })
