...
import { octopusApi, octopusApiOuter, octopusRepostApi } from './request'
...
export async function createPrepayOrderMintBtc(data: any) {
  return await octopusRepostApi<any>('/createPrepayOrderMintBtc').post(data)
}

export async function createPrepayOrderMintMrc20(data: any) {
  return await octopusRepostApi<any>('/createPrepayOrderMintMrc20').post(data)
}
...
export async function submitPrepayOrderMintBtc(data: any) {
  return await octopusRepostApi<any>('/submitPrepayOrderMintBtc').post(data)
}

export async function submitPrepayOrderMintMrc20(data: any) {
  return await octopusRepostApi<any>('/submitPrepayOrderMintMrc20').post(data)
}
